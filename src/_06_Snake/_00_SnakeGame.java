...
public class _00_SnakeGame implements ActionListener, KeyListener {
	...
	public void startGame() {
		...
		String instructions = "use wasd to move, collect things";
	...
	private void setFoodLocation() {
		...
		Location loc = setRandomLocation();
	...
	private void gameOver() {
		...
		int result = JOptionPane.showConfirmDialog(null, "Want to play again :))", "", dialogButton);
		// 4. if they want to play again
		// reset the snake and the food and start the timer
		// else, exit the game
		if(result == 0) {
			snake.reset(setRandomLocation());
			setFoodLocation();
		}
		else {
			System.exit(0);
